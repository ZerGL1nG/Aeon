...
namespace AI.NeuralNetwork
{
    ...
    {
        public static Func<float, float> GetActivationFunc(ActivationFunctions func) => func switch
        {
        ...
        public static Func<float, float> GetDerivativeFunc(ActivationFunctions func) => func switch
        {
