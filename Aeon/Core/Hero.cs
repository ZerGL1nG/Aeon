...
public class Hero
{
    ...
    public static readonly Dictionary<Stat, double> InitStats = new() {
        { Stat.Health, 100 },
        { Stat.Attack, 15 },
        { Stat.Spell, 0 },
        { Stat.CritChance, 0 },
    ...
    public static readonly Dictionary<Stat, StatCosts> InitCosts = new() {
    ...
    private bool RandCrit(double critChance) =>
        ...
        return false;*/
        critChance > Random.Shared.NextDouble();
    ...
    public virtual Attack MakeAttack()
    {
        ...
        var att = RandCrit(cChance) switch {
            true => new Attack(this, attack*cDamage, spell), false => new Attack(this, attack, spell),
        };
        CurrentIncome *= 1+cInc;
        return att;
    }

    public virtual void StartBattle() => Reset();
    ...
    public virtual void EndBattle(bool win)
    {
        ...
        if (win) {
            ...
            Stats.AddStat(Stat.Money, gameMoney);
    }
    ...
    public bool CanBuy(Stat stat, bool opt)
    {
        ...
        if (stat == Stat.Shield && Stats.CalculateShield(Stats.GetStat(Stat.Shield)) >= Stats.maxShield) return false;
        return true;
    }
