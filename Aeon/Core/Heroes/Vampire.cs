...
public class Vampire: Hero
{
    ...
    public Vampire() => HeroClass = HeroClasses.Vampire;
    ...
    public override double GetAbilityState() => AbilityLevel;
    ...
    public override Attack MakeAttack()
    {
        ...
        return new Attack(att.Source, att.Damage*(1+Suck[AbilityLevel-1]), att.Magic, att.True, att.Critical);
    }
}