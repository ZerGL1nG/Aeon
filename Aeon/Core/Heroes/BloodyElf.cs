...
public class BloodyElf: Hero
{
    ...
    private readonly Dictionary<Abilities, int> AbilityManaCost = new() {
        { Abilities.Nothing, 0 }, { Abilities.MoneyBurn, 3 }, { Abilities.SuperMag, 4 }, { Abilities.UberRegen, 5 },
    };

    private Abilities CurrentAbility = Abilities.Nothing;
    private int CurrentMana;

    private bool regenFlag;

    public BloodyElf() => HeroClass = HeroClasses.BloodyElf;
    ...
    public override Attack MakeAttack()
    {
        ...
        case Abilities.Nothing: return att;
    ...
    private enum Abilities { Nothing, MoneyBurn, SuperMag, UberRegen, }
}