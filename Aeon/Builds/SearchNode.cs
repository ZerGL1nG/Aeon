...
internal class SearchNode
{
    public static readonly List<Stat> TestingStats = new() { 
        ...
        Stat.Regen, Stat.Armor, //Stat.Income,
        //Stat.Shield, Stat.CritChance, Stat.CritDamage,
    };
    //{ Stat.Health, Stat.Attack, Stat.Spell };

    public readonly SearchNode ParentNode = null;
    ...
    {
        if (!matchups.ContainsKey(enemy))
            matchups[enemy] = new NodeData();
    ...
    private static Dictionary<string, SearchResult> _nodes = new();
